...
FindStaticsWindow::FindStaticsWindow(ProcessHandle* proc, QWidget* parent)
    ...
    setWindowTitle(QObject::tr("Find Statics"));
    resize(720, 540);
    ...
    row->addWidget(new QLabel(QObject::tr("Module:")));
    ...
    statusLabel_ = new QLabel(QObject::tr("Pick a module and click Scan."));
    layout->addWidget(statusLabel_);

    table_ = new QTableWidget;
    table_->setColumnCount(3);
    table_->setHorizontalHeaderLabels({QObject::tr("Static address"), QObject::tr("Symbol"), QObject::tr("References")});
...
void FindStaticsWindow::onScan() {
    ...
    statusLabel_->setText(QObject::tr("Done: %1 static addresses found.").arg(statics.size()));
