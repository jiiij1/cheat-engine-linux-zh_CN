...
GraphicalMemoryView::GraphicalMemoryView(ce::ProcessHandle* proc, QWidget* parent)
    ...
    setWindowTitle(QObject::tr("Graphical Memory View"));
    resize(560, 620);
