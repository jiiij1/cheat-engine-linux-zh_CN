...
MemoryRegionsWindow::MemoryRegionsWindow(ProcessHandle* proc, QWidget* parent)
    ...
    setWindowTitle(QObject::tr("Memory Regions"));
    resize(800, 500);
    ...
    table_->setHorizontalHeaderLabels({QObject::tr("Start"), QObject::tr("End"), QObject::tr("Size"), QObject::tr("Perm"), QObject::tr("Path")});
...
void MemoryRegionsWindow::populate() {
    ...
    setWindowTitle(QObject::tr("Memory Regions: %1 regions, %2 MB readable")
