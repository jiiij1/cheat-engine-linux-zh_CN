...
ModuleListWindow::ModuleListWindow(ProcessHandle* proc, QWidget* parent)
    ...
    setWindowTitle(QObject::tr("Module List"));
    resize(850, 500);
    ...
    table_->setHorizontalHeaderLabels({QObject::tr("Base"), QObject::tr("Size"), QObject::tr("Name"), QObject::tr("Path")});
...
void ModuleListWindow::populate() {
    ...
    setWindowTitle(QObject::tr("Module List - %1 modules").arg(modules.size()));
}
